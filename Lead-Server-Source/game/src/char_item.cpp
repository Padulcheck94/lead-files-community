...
void NotifyRefineSuccess(LPCHARACTER ch, LPITEM item, const char* way)
{
	...
	{
		ch->ChatPacket(CHAT_TYPE_COMMAND, LC_TEXT("RefineSuceeded"));
...
void NotifyRefineFail(LPCHARACTER ch, LPITEM item, const char* way, int success = 0)
{
	...
	{
		ch->ChatPacket(CHAT_TYPE_COMMAND, LC_TEXT("RefineFailed"));
...
void CHARACTER::__OpenPrivateShop()
{
	...
	switch (bodyPart)
	{
		...
		case 1:
		case 2:
			ChatPacket(CHAT_TYPE_COMMAND, LC_TEXT("OpenPrivateShop"));
			break;
		default:
									...
									if (pMap != NULL)
									{
										...
										if (f.m_mapStone.size() > 0)
										{
											...
											if (pTarget != NULL)
											{
												...
												ChatPacket(CHAT_TYPE_COMMAND, LC_TEXT("StoneDetect %u %d %d"), (DWORD)GetVID(), val,
										...
										{
											ChatPacket(CHAT_TYPE_COMMAND, LC_TEXT("StoneDetect %u 0 0"), (DWORD)GetVID());
											ITEM_MANAGER::instance().RemoveItem(item);
										}
									}
									break;
