	...
	if (item)
	{
		if (item->IsDragonSoul())
		{
			...
			else
			{
				...
				{
					ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("Before you open the Cor Draconis, you have to complete the Dragon Stone quest and activate the Dragon Stone Alchemy."));
				}
				else
